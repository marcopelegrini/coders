...
(function(){
    ...
    com.coders.changeHosts.dnsFlusher = {
        ...
        init: function(){
            ...
            this.prefs = new this.utils.prefs(this.ch.constants.branchName);
            this.logger = new this.utils.log(this.prefs);
            
            this.Listener = {
                onLocationChange: function(aProgress, aRequest, aLocation){
                    try {
                        if (aLocation && (aLocation.scheme != 'chrome') && (aLocation.scheme != 'file') && (aLocation.scheme != 'about') && aLocation.host) {
        ...
        updateLabel: function(host, ips, byUser){
            ...
            var ipLabel = this.utils.util.getElement('CH_status_ip');
            this.cleanTooltip();
            //Status bar label
        ...
        cleanTooltip: function(){
            //Remove old tooltips
            var tooltip = this.utils.util.getElement('CH_status_tooltip');
