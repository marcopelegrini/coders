    ...
    coders.fileUtils = {
        ...
        save: function(filePath, output){
            try {
                ...
                throw "Error saving " + filePath + ". Check file permission." + ex;
            }
        },
        ...
        saveFile: function(file, output){
            try {
                ...
                throw "Error saving " + file.path + ". Check file permission." + ex;
            }
        },
        ...
        read: function(filePath){
            ...
            // file.initWithPath(filePath);
            // if (!file.exists()) {
            //     throw new coders.changeHosts.FileNotFoundException("File '" + filePath + "' does not exists.");
            // }
            // if (!file.isFile()) {
            ...
            var promiseExists = OS.File.exists(filePath);
            promiseExists = promiseExists.then(
