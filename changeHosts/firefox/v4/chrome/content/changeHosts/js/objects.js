...
coders.changeHosts.FileCountExceededException = function(message){
  this.name = "coders.changeHosts.FileCountExceededException";
  this.message = (message || "");
};

coders.changeHosts.FileCountExceededException.prototype = new Error();
coders.changeHosts.FileCountExceededException.constructor = coders.changeHosts.FileCountExceededException;
