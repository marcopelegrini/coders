...
var XpiInstaller = {
	...
	extFullName: 'Gerador de Cartões de Crédito', // The name displayed to the user (don't include the version)
	extShortName: 'creditCardGeneratorOverlay', // The leafname of the JAR file (without the .jar part)
	extVersion: '1.0.4.2',
	extAuthor: 'Carlos Eugenio Torres',
	extLocaleNames: null, // e.g. ['en-US', 'en-GB']
	extSkinNames: null, // e.g. ['classic', 'modern']
	extPostInstallMessage: 'Pronto! Por favor, reinicie o navagador para completar a instalacao.', // Set to null for no post-install message
	// --- Editable items end ---
